...
<tr>
	...
	<td><%=user.getUserName() %></td>
 	...
 	<td><%=stopflag %></td> 
 	<td><a href="preUpdateUser.do?id=<%=user.getId()%>" ><!-- <input type="button" value="修改"> --><input class="button blue small" type="button" value="修改" > </a></td> 
 	<td><a href="deleteUser.do?id=<%=user.getId()%>"><!-- <input type="button" value="删除"> --><input class="button blue small" type="button" value="删除" ></a></td>
 </tr>
<%} %>
</table><br>
