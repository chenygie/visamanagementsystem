...
<tr>
 	...
 	<td><%=sm.getSerCharge() %></td>
   	...
   	<td><a href="preUpdateServiceMaintainIn.do?id=<%=sm.getId()%>" ><input class="button blue small" type="button" value="修改" ></a></td> 
   	<td><a href="deleteServiceMaintainIn.do?id=<%=sm.getId()%>"><input class="button blue small" type="button" value="删除" ></a></td>
</tr>
<%} %>
</table><br>

<a href="addServiceMaintainIn.jsp"><input class="button orange middle" type="button" value="添加服务项" ></a>&nbsp;
