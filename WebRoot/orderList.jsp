...
<a href="cancelSession.do"><input type="button" value="注销"><br></a>
...
<!-- 发票编号-->
发票编号：<input type="text" name="invoice_code" style="width:220px;"/>&nbsp;
...
session.setAttribute("bis1", bis);
 ...
 <!-- 生成付款通知书按钮 -->
<% if(type==2){//财务%>
<input class="button gray middle" type="button" value="生成付款通知书" >
 <%}else if(type==1||type==3){//业务员和管理员%>
<a href="chooseCompany.jsp"><input class="button orange middle" type="button" value="生成付款通知书" ></a>
 <%}%>
...
<input class="button gray middle" type="button" value="返回到用户列表" >
 <%}else if(type==3){%>
 <a  href="manageUser.do"><input class="button orange middle" type="button" value="返回到用户列表" ></a>
 <%}%>
 
<!--  进入到通知书列表页面 -->
 <%if(type==2||type==3){ %>
 <a  href="noticeList.do"><input class="button orange middle" type="button" value="进入通知书列表页面" ></a>
 <% } %>
</body>
</html>