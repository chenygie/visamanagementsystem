...
<tr>
 	...
 	<td><%=company.getCompanyName()%></td>
   	<td><a href="preUpdatecompanyMaintain.do?id=<%=company.getId()%>" ><input class="button blue small" type="button" value="修改" ></a></td> 
   	<td><a href="deleteCompanyMaintain.do?id=<%=company.getId()%>"><input class="button blue small" type="button" value="删除" ></a></td>
</tr>
<%} %>
</table><br>

<a href="addCompanyMaintain.jsp"><input class="button orange middle" type="button" value="添加公司" ></a>&nbsp;
<a href="manageUser.do"><input class="button orange middle" type="button" value="返回" ></a>&nbsp;
</div>
</body>
</html>